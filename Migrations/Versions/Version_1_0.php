...
class Version_1_0 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        {
            //columns
            $table->addColumn("position_id", "bigint", ["unsigned" => true, "autoincrement" => true]);
        ...
        $schema->create("user_teams", function(Blueprint $table, Schema $schema)
        {
            ...
            $table->addColumn("position_id", "bigint", ["unsigned" => true]);
            ...
            $table->addForeignKey("position_id", $schema->getTable("positions"), "position_id", Blueprint::ACTION_AFFECT);
            
            $table->addUnique(["user_id", "team_id", "position_id"]);
        });
        

        //////////////////////////
        // TABLE USER_TEAM_META //
        //////////////////////////
        $schema->create("user_team_meta", function(Blueprint $table, Schema $schema)
        {
            $table->addColumn("meta_id", "bigint", ["unsigned" => true, "autoincrement" => true]);
